...
public:
    ...
    Player* newplayer;
        ...
        std::cin>> name;
        std::cout<<"Enter who you were before the recruitement\n1 - You were a homeless hobo, your posessions numbered the old gun your pal gave you before he passed and the tattered rags you wear. You can cause some havoc with the gun you own, but, your unhealthy life before and tattered armor does not make you very tough."<<std::endl;
        ...
        std::cout<<"3 - You were a Riot officer on one of the core worlds, you've been reassigned by your commander to the planetary exploration Beaureau. A demotion for sure, but they allowed you to keep your armored suit and your shock baton. You might not be able to move very well or hit very hard, but your armor protects you against the strongest of hits." <<std::endl;
        std::cin>>input;
        switch(input)
         {
                case '1':
