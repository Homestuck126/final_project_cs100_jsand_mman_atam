...
quests_in->addQuest(new Quest("Your communicator once again blazes out a very familiar voice \"WHAT ARE YOU DOING YOU BUFFON, START LOOKING.\" You decide that it's probably a good idea to do what you officer says and start looking.","Explore the blue planet","You've arrived at the end of this shore, and all you see is Ocean",blue,Ocean));
...
quests_in->addQuest(new Quest("Reinvigorated by the idea of cool loot, you decied to go over to the temple.","Go to the temple.","You arrive at the temple, it reminds you of something very blocky, watching out for tripwires and dispensers, you read the shrine message again.",Pillar,Temple));
quests_in->addQuest(new Quest("Knowing the message, you think on how to solve it.","Solve the puzzle.","You've arrived at the lava river, sucking some lava into your suit resivour.",Temple,River));
...
quests_in->addQuest(new Quest("The temple echos and shakes, as you pour the lava into the brazier. As the lava flows through the brazier, the words above change temporarily, \"Go to the Tower and slap yourself\". A little bit strange, but little trouble for sweet loot you suppose.","Go to the Tower and commit THE SLAP","You arrive at the Tower, guess it's time to slap yourself. This feels weird.",Temple, Tower));
